...
const successList: Record<string, string> = {
...
export const useAlert = (type = '', msg = '') => {
  if (type === 'success') {
    const message = successList[msg] || msg || 'Success!'

    toast.success(message)
  }

  if (type === 'error') {
    const message = errorList[msg] || msg || 'Unknown error occurred!'
